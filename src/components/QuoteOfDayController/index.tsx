...
const QuoteOfDayController: FC = () => {
  const achievements = useSelector<IAppState, IAchievement[]>((state) => state.achievements.data, shallowEqual);
  const date = useSelector<IAppState, Date>((state) => state.datePicker.value, shallowEqual);
